                ...
                <div className="flex flex-col items-center justify-center">
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <h1 className="mt-4 text-3xl font-bold tracking-tight text-gray-700 sm:text-5xl">
                            {title ? title : __('No results found', 'plugin-name')}
                        </h1>
                        <p className="mt-6 text-base leading-7 text-gray-400">
                            {description ? description : __('Try adjusting your search or filter to find what you are looking for.', 'plugin-name')}
                        </p>
                    </div>
                </div>
            </div>
